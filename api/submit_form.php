...
//    echo $data['email'] = strtolower($data['email']);
//    echo $dele_title = ""; echo "<br>";
//    echo $dele_fname = $data['first_name']; echo "<br>";
//    echo $dele_lname = $data['last_name'];echo "<br>";
//echo     $dele_desig = $data['designation'];echo "<br>";
//    echo $dele_email = strtolower($data['email']);echo "<br>";
//   echo  $dele_cntry_code = $data['country_code'];echo "<br>";
//    echo $dele_mob = $data['phone'];echo "<br>";
//    echo $org = $data['company'];echo "<br>";
//    echo $country = $data['country']; echo "<br>";
//    echo $reg_cata = $data['delegate_type'];echo "<br>";
...
//        die;
    ...
    $sql = "INSERT INTO ieia_2024_reg_api_log(booking_id, email, request, created_at) VALUES('" . $bid . "', '" . strtolower($data['email']) . "', '" . dbMysqli_real_escape_string(json_encode($data)) . "', '" . date('Y-m-d H:i:s') . "')";
    dbQuery($sql);
//        exit;
    ...
    /*mysqli_query($link, "UPDATE " . $EVENT_DB_FORM_REG . " SET tin_no = '$tin_no1' WHERE reg_id = '$reg_id'") or die(mysqli_error());*/
    ...
    if ($qry_email_chk_num >= 1) {
        ...
        $sql = "update ieia_2024_reg_api_log set response='" . dbMysqli_real_escape_string($res) . "' where booking_id = '" . $bid . "'";
        dbQuery($sql);
        echo $res;
        return;
    } else {
        ...
        /*dbQuery("insert  into `" . $EVENT_DB_FORM_ALL_USERS_SCHEDULE . "` (`req_date`,`req_time`,`sender_id`,`sender_title`,`sender_fname`,`sender_lname`,`sender_org`,`sender_desig`,`sender_org_profile`,`sender_email`,`receiver_id`,`receiver_title`,`receiver_fname`,`receiver_lname`,`receiver_org`,`receiver_desig`,`receiver_org_profile`,`receiver_email`,`req_type`,`meeting_date`,`meeting_time_start`,`meeting_time_end`,`message`,`status`,`read_flag`,`table_no`) values
                ...
                (NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','16:00:00 pm','16:30:00 pm',NULL,'',NULL,NULL),
                (NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','16:30:00 pm','17:00:00 pm',NULL,'',NULL,NULL),
                (NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','17:00:00 pm','17:30:00 pm',NULL,'',NULL,NULL)") or die(mysqli_error($link));
