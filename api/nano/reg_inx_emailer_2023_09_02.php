		...
		<form id='form11' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
			  ...
			  We are pleased to inform you that you now have access to B2B Partnering (InterlinX)- The Online Partnering Tool, which will enable you to: 
              ...
              <p><strong>Please find below your login details:</strong><br/>
              	<a href='".$interlink."' target='_blank'>Click Here</a> to login to ".$EVENT_NAME." ".$EVENT_YEAR." B2B Partnering (InterlinX).<br/>
            ...
            <tr>
              <td colspan='4' valign='top' class='style4'>
              <p>Best Regards,<br/>
              " . $EVENT_NAME . "-" . $EVENT_YEAR . " - B2B Partnering (InterlinX) Secretariat</p></td>
            </tr>
          </table>
		  <p class='submit'>&nbsp;</p>								
  </form>		
