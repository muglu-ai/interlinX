...
//        exit;
        ...
        $sql = "UPDATE ieia_2024_interlinx_reg_table SET reg_cata = '$reg_cata' WHERE pri_email = '$email'";
        echo $sql;
        $result = dbQuery($sql);
        ...
        $sql_up = "SELECT * from ieia_2024_interlinx_reg_table where pri_email = '$email'";
