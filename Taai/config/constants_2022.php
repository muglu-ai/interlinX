...
define('PROJECT_LOGO', 'assets/img/bts-2022.png');
...
define('EVENT_YEAR', 2022);



define('EVENT_DATE', 'November 16 to 18,' . EVENT_YEAR);

define('EVENT_WEBSITE', 'https://www.bengalurutechsummit.com/');

define('EVENT_MAILER_LOGO_LINK', EVENT_WEBSITE . 'web/it_forms/images/logo.png');

define('EVENT_ENQUIRY_EMAIL', 'enquiry@bengalurutechsummit.com');

define('EVENT_INTERLINX_NO_OF_DAYS', 3);

define('EVENT_INTERLINX_DATE_ARR', serialize(array('2022-11-16', '2022-11-17', '2022-11-18')));



define('INTERLINX_FOLDER_NAME', 'web/interlinx-2022/');

define('INTERLINX_LINK', 'https://www.bengalurutechsummit.com/web/interlinx-2022/');//http://www.interlinx.in/
...
define('ZOOM_MEETING_ACTIVATE_DATE', '2023-11-17');
...
define('EVENT_INTERLINX_LINK', EVENT_WEBSITE . INTERLINX_FOLDER_NAME);
