...
<section class="content-header">
	<div class="container">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Interested Industry Sector</h1>
			</div>
		</div>
	</div>
	<!-- /.container-fluid -->
...
<section class="content">
	<div class="container">
    	<div class="row">
    		<div class="col-12">
    			<form action="<?php echo base_url('industry-sectors');?>" method="post" name="form1" id="form1" onsubmit="return validate_step_comm_2()">
        					...
        					<div class="row">
        						<?php $ind_sec_count = 1; foreach ($industry_sector_list as $industry_sector) {?>
            						<div class="col-md-3 col-sm-3 col-xs-6">
    									<label>
    										<input type="checkbox" name="intr<?php echo $ind_sec_count;?>" id="intr<?php echo $ind_sec_count;?>" value="<?php echo $industry_sector['comm_name'];?>" class="mr-2 mt-3" <?php if($res['intr'.$ind_sec_count] == $industry_sector['comm_name']){ echo 'checked="checked"';  }?>>
    										<?php echo $industry_sector['comm_name'];?>
    									</label> 
        							</div>
        						<?php $ind_sec_count++;}?>
        						<div class="col-md-3 col-sm-3">
    								<label><input type="checkbox" name="intr_other" id="intr40" value="OTHER" class="mr-2 mt-3" <?php if($res['intr_other']){ echo 'checked="checked"';  }?> >Other</label> 
    								<div class="col-md-12" id="specify_other_div">
    									<input type="text" id="specify_other" name="specify_other" value="<?php echo $res['intr_other'];?>" class="form-control">
    								</div>
    							</div>
        					</div>
    					</div>
