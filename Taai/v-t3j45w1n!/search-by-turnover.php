			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					<form class="form-horizontal1 col-md-12 pl-lg-5 pr-lg-5 pt-2" name="inForm" action="<?php echo base_url('search-redirect');?>">
						<input type="hidden" id="type" name="type" value="turn"/>
						<div class="card-body align-self-center col-md-12">
							<div class="form-group row">
								<label for="inputEmail3" class="col-md-2 col-form-label font-weight-bold">Enter Turnover Range</label>
								<div class="col-md-2">
									<input type="number" name="from" class="form-control" placeholder="From" value="<?php echo $from;?>" required="required">
								</div>
								<div class="col-md-2">
									<input type="number" name="to" class="form-control" placeholder="To" value="<?php echo $to;?>" required="required">
								</div>
								<div class="col-md-2">
									<select name="cur" class="form-control" id="cur" required="required">
										<option value="">-- Currency--</option>
    									<?php $industries = array('INR', "USD");
    									   foreach ($industries as $industry) {?>
    										<option value="<?php echo $industry;?>" <?php if($industry == $cur) {?>selected="selected"<?php }?>><?php echo $industry;?></option>  
    									<?php }?>
    								</select>
								</div>
