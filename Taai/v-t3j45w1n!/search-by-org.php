...
<section class="content-header">
	<div class="container">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Search By Organisation Name</h1>
			</div>
		</div>
	</div>
	<!-- /.container-fluid -->
			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					<form class="form-horizontal1 col-md-12 pl-lg-5 pr-lg-5 pt-2" name="inForm" action="<?php echo base_url('search-redirect');?>">
						<input type="hidden" id="type" name="type" value="org"/>
						<div class="card-body align-self-center col-md-12">
							<div class="form-group row">
								<label for="inputEmail3" class="col-md-2 col-form-label font-weight-bold">Select Organisation </label>
								<div class="col-md-6">
									<select name="search" class="form-control select2" id="search-org"  style="width: 100%;">
										<option value="">-- Select --</option>
    									<?php foreach ($orgList as $industry) {?>
    										<option value="<?php echo base64_encode($industry['org_name']);?>" <?php if(($industry['org_name']) == $param) {?>selected="selected"<?php }?>><?php echo $industry['org_name'];?></option>  
    									<?php }?>
    								</select>
								</div>
