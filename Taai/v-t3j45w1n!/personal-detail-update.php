				...
				<div class="card">
					<div class="card-header p-2">
						<ul class="nav nav-pills">
							...
							<li class="nav-item"><a class="nav-link active">Edit Profile</a></li>
								...
								<form action="<?php echo base_url('personal-detail/update');?>" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validate_personal_info()">
									...
									<div class="form-row" style="display: none;">
										<div class="form-group col-md-6">
											...
											<textarea class="form-control" name="addr_line1" id="addr_line1" placeholder="Apartment, studio, or floor" ><?php echo $res['addr1'];?></textarea>
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-4">
											...
											<input type="text" class="form-control" name="state" id="state" value="<?php echo $res['state'];?>" placeholder="State">
										</div>
										<div class="form-group col-md-4">
