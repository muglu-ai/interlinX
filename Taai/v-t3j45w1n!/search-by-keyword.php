					...
					<form class="form-horizontal1 col-md-12 pl-lg-5 pr-lg-5 pt-2" name="inForm" action="<?php echo base_url('search-redirect');?>">
						...
						<div class="card-body align-self-center col-md-12">
							<div class="form-group row">
								<label for="inputEmail3" class="col-md-2 col-form-label font-weight-bold">Enter Keyword </label>
								<div class="col-md-6">
									<input type="search" name="search" class="form-control" placeholder="Search here..." value="<?php echo $param;?>">
								</div>
