	...
	<div class="wrapper d-head">
		...
		<div class="container">
			<nav class="main-header navbar navbar-expand navbar-white navbar-light bg-white p-md-3 p-sm-0">
				<ul class="navbar-nav">
					<li><a href="<?php echo EVENT_WEBSITE; ?>" target="_blank"><img src="<?php echo base_url(PROJECT_LOGO); ?>" width="275" class="img-fluid"></a></li>
				</ul>
		...
		<div class="content-wrapper login-page pt-sm-3">
			<div class="login-box rounded">
				...
				<div class="card card-primary ">
					...
					<div class="card-body">
						<p class="login-box-msg h5"><strong>We will notify the delegates via email once Partnering tool - InterlinX gets open for delegates. </strong></p>
						...
						<p class="mb-1 mt-2">
							<?php /* ?> 
							<a href="<?php echo base_url('forgot-password'); ?>">I forgot my password</a> | <a href="<?php echo EVENT_INTERLINX_REG_LINK; ?>" target="_blank">Register</a>
							<?php */ ?>
						</p>
					</div>
					<!-- /.card-body -->
