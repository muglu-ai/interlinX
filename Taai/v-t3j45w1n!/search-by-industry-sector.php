...
<section class="content-header">
	<div class="container">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Search By Industry Sector</h1>
			</div>
		</div>
	</div>
	<!-- /.container-fluid -->
			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					<form class="form-horizontal1 col-md-12 pl-lg-5 pr-lg-5 pt-2" name="inForm" action="<?php echo base_url('search-redirect');?>">
						<input type="hidden" id="type" name="type" value="industry"/>
						<div class="card-body align-self-center col-md-12">
							<div class="form-group row">
								<label for="inputEmail3" class="col-md-2 col-form-label font-weight-bold">Select Industry Sector</label>
								<div class="col-md-6">
									<select name="search" class="form-control" id="search">
										<option value="">-- Select --</option>
    									<?php foreach ($industries as $industry) {?>
    										<option value="t3j<?php echo ($industry['srno']);?>" <?php if(($industry['comm_name']) == $param) {?>selected="selected"<?php }?>><?php echo $industry['comm_name'];?></option>  
    									<?php }?>
    								</select>
								</div>
