    						...
    						<div class="row">
    							...
    							<div class="col-md-10 p-2 mar bg-light">
    								<marquee direction="left" behavior="scroll" scrollamount="4" class="a-main1">
    									Welcome to BTS <?php echo EVENT_YEAR;?> B2B Partnering Tool
    								</marquee>
    							</div>
    						</div>
    					</div>
    	...
    	<div class="row">
    			...
    			<div class="col-md-12 col-sm-12 col-xs-12 mb-3">
    				...
    				<div class="card">
    					...
    					<div class="card-body bg-light">
    						<div class="row">
    							<!-- /.col -->
    							<?php $i = 1;foreach ($shortlistPartners as $shortlistPartner) {
    							    if($i > 8) {
    							         break;
    							    }?>
        							<div class="col-md-3">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="card">
					...
					<div class="card-body bg-light">
						<div class="row">
							<?php $i = 1;foreach ($matchedList as $shortlistPartner) {
							    if($i > 8) {
							         break;
							    }?>
    							<div class="col-md-3">
